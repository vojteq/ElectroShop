                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-4 offset-sm-1">
                        ...
                        <address>
                            ...
                            <i className="fa fa-envelope"/>: <a className="my-link"
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text
                                        ...
                                        className="form-control"
                                        validators={{
                                            required, minLength: minLength(9), maxlength: maxLength(9), isNumber
                                        }}
                                    />
                                    <Errors
                                        className="text-warning"
                                        ...
                                        messages={{
                                            required: "Required / ",
                                            minLength: "Must be 9 numbers length / ",
                                            maxLength: "Must be 9 numbers length / ",
